...
<html lang="en-us" id="extr-page">
	<head>
		<meta charset="utf-8">
		<title> SyntBots - Login Page</title>
				...
				<div class="row">
				  <div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
					<div id="logo-group">
						...
						<span> <img src="img/syntbots_original.png"
							width="100%" height="850%" alt="SYNTBOTS">
						</span>
					</div>
				  </div>
         ...
         <div class="page-footer" style="padding: 15px 13px 0px;">
			<div class="row">
				<div class="col-xs-12 col-sm-6">
					<span class="txt-color-white">SyntBots - Syntel, Inc. &copy; 2015</span>
				</div>
			</div>
		</div>
		<!-- END PAGE FOOTER -->

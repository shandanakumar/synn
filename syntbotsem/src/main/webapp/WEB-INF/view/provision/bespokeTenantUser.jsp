																...
																<header>
																   ...
																   <!-- widget div-->
																	...
																	<div class="widget-body no-padding">						
																		<form name="bespokeConfigLaunchForm" id="addForm" class="smart-form" action="bespokeUserServiceList">																										
																			...
																			<fieldset>
																	            ...
																	            <div id="azureBlock" style="display:none">
																                      <section class="col col-10">
																						<label class="label">Tomcat Username</label> 
																						<label class="input">
																						...
																						<section class="col col-6">
																						<label class="label">Tomcat Password</label> 
																						<label class="input">
																							<input type="password" name="azurePassword" id="azurePassword" placeholder="Password">
																						</label>
																						</section>
																						<section class="col col-6">
																						<label class="label">Confirm Tomcat Password</label> 
																						<label class="input">
																			 			...
																			 			<!-- <section class="col col-10">
																							<label class="label">Network</label>
																									<label class="select">
																										...
																										<option value="0" selected="selected" disabled="">Select Network</option>
																										<option value="1"  >Private-Net</option>
																							</select>  <i></i> </label>
																						</section>  -->
																						<section class="col col-10">
	...
	<script type="text/javascript">
       ...
       function launchAzureBespokeInstance(){
    		...
    		$.ajax({     
    			...
    			success:function(data){
    				alert('inside  success block:'+data+':');
    				getBespokeServiceList();
    			},     
    			error:function(XMLHttpRequest){ 
    				alert('Error Occured with response as:'+XMLHttpRequest.responseText);
    				//getBespokeServiceList();
    			}
    		});
       }
       
       function getBespokeServiceList(){
    	   document.getElementById("bespokeConfigLaunchForm").submit();  
       }

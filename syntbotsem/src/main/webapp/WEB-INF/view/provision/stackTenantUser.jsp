...
<html lang="en-us">
	<head>
		...
		<title>SyntBots User Stack Service Page </title>
    ...
    <body class="menu-on-top">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Home</li><li>Provision VM</li><li>Stack Service</li>
				</ol>
			</div>
			<!-- END RIBBON -->
										...
										<div class="panel panel-default">
											...
											<div id="collapseOne-1" class="panel-collapse collapse">
													<div class="panel-body">
													 ...
													 <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal"  class='btn btn-xs btn-success pull-right' role="button">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="text-center error-box">
									...
									<h2 class="font-xl"><strong><i class="fa fa-fw fa-warning fa-lg text-warning"></i> Stack Service Development Under Process </strong></h2>
									<br />
									<p class="lead">

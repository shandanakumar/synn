...
<html lang="en-us">
	<head>
		...
		<title> SyntBots User KeyPair List</title>
		...
		<aside id="left-panel">
			...
			<ul>
				...
				<li  ><a href="endUserProjectQuota"><i
						class="fa fa-lg fa-fw fa-cogs"></i> <span class="menu-item-parent">
							Quota</span></a></li>
		<li   class="active"><a href="projectKeyPairList"><i
						class="fa fa-lg fa-fw fa-cogs"></i> <span class="menu-item-parent">
				                        ...
				                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											<thead>								
												<tr>
									                ...
									                <th data-hide="phone,tablet" colspan="1">Created On</th>	
												</tr>
											</thead>
											<tbody>

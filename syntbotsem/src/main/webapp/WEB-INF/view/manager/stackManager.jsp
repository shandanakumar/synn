...
<title>SyntBots Manager Stack Service</title>
...
<body class="desktop-detected menu-on-top pace-done smart-style-4">
			...
			<ul>
				...
				<li class="active"><a href="#"><i
					...
					<ul>
						...
						<li class="active"><a href="#">Stack Service </a></li>
									...
									<div class="panel-group smart-accordion-default"
											...
											<div class="row">
													...
													<div class="panel-heading">
														<h4 class="panel-title">
															<a data-toggle="collapse" class="collapsed"
																data-parent="#accordion-2" href="#collapseOne-1"> <i
																class="fa fa-fw fa-plus-circle txt-color-green"></i> <i
																class="fa fa-fw fa-minus-circle txt-color-red"></i>
																Tomcat Dev Stack
															</a>
														</h4>
													</div>
												...
												<div class="col-xs-12 col-sm-3 col-md-3">
													<a href="javascript:void(0);" id="show-shortcut"> <img
														src="img/tomcat_logo.gif" width="15%" height="15%"
														alt="tomcat"
														style="padding-top: 3px; padding-bottom: 3px;" /> <img
														src="img/JBoss_logo.png" width="17%" height="15%"
														alt="Jboss" style="padding-top: 3px; padding-bottom: 3px;" />
														<img src="img/mysql-logo.png" width="16%" height="15%"
														alt="mysql" style="padding-top: 3px; padding-bottom: 3px;" />
														<img src="img/cluster.png" width="15%" height="15%"
														alt="cluster"
											...
											<div id="collapseOne-1" class="panel-collapse collapse">
												<div class="panel-body">
													...
													<button class='btn btn-xs btn-success pull-right'>
														<i class="fa fa-shopping-cart"></i> Launch <span>
															now!</span>
													</button>
												</div>
											</div>
										...
										<div class="panel panel-default">
											<div class="panel-heading">
												<h4 class="panel-title">
													<a data-toggle="collapse" data-parent="#accordion-2"
														href="#collapseFour-1" class="collapsed"> <i
														class="fa fa-fw fa-plus-circle txt-color-green"></i> <i
														class="fa fa-fw fa-minus-circle txt-color-red"></i> FP App
														Testing
													</a>
												</h4>
											</div>
										...
										<div class="panel panel-default">
											<div class="panel-heading">
												<h4 class="panel-title">
													<a data-toggle="collapse" data-parent="#accordion-2"
														href="#collapseFive-1" class="collapsed"> <i
														class="fa fa-fw fa-plus-circle txt-color-green"></i> <i
														class="fa fa-fw fa-minus-circle txt-color-red"></i> Supply
														Chain Dev
													</a>
												</h4>
											</div>
										...
										<div class="panel panel-default">
											<div class="panel-heading">
												<h4 class="panel-title">
													<a data-toggle="collapse" data-parent="#accordion-2"
														href="#collapseSix-1" class="collapsed"> <i
														class="fa fa-fw fa-plus-circle txt-color-green"></i> <i
														class="fa fa-fw fa-minus-circle txt-color-red"></i>
														SharePoint Dev
													</a>
										...
										<div class="panel panel-default">
											<div class="panel-heading">
												<h4 class="panel-title">
													<a data-toggle="collapse" data-parent="#accordion-2"
														href="#collapseSeven-1" class="collapsed"> <i
														class="fa fa-fw fa-plus-circle txt-color-green"></i> <i
														class="fa fa-fw fa-minus-circle txt-color-red"></i>
														...
														<table class="table table-bordered">
															...
															<tbody>
																<tr>
																	...
																	<td>2</td>
																	<td>20</td>
																	<td>Java 1.7 , MySql 5.5 , Websphere 8.5 , SVN 1.8
																		, Eclipse Luna</td>
																	<td><span class="label label-warning">VCenter-Pune-DC</span></td>
																</tr>
															</tbody>
										...
										<div class="panel panel-default">
											<div class="panel-heading">
												<h4 class="panel-title">
													<a data-toggle="collapse" data-parent="#accordion-2"
														href="#collapseEight-1" class="collapsed"> <i
														class="fa fa-fw fa-plus-circle txt-color-green"></i> <i
														class="fa fa-fw fa-minus-circle txt-color-red"></i>
														AppStack Dev
													</a>
	...
	<script
		src="js/plugin/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>

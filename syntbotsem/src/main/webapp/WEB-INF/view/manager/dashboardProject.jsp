...
<title>SyntBots Corporate User - Project Home</title>
...
<body class=" ">
	...
	<aside id="left-panel">
		...
		<nav>
			<ul>
				<li class="active"><a href="dashboardProject" title="Dashboard"><i
						class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">Dashboard</span></a>
				</li>
				<li><a href="endUserList" title="endUserList"><i
							...
							<div class="col-md-4 padding-left-0">
								<h3 class="margin-top-0">
									<a href="javascript:void(0);">
										Welcome,&nbsp;${userValue.usr_name} </a> <a
										class="btn btn-primary pull-right" href="endUserList">
										List / Add Poject Users </a> <br>
								</h3>

...
<title>SyntBots Manager Service Extensions</title>
	...
	<aside id="left-panel">
		...
		<nav>
			<ul>
				...
				<li class="active"><a href="#" title="Service Extensions"><i
									...
									<table class="table table-bordered table-striped">
										...
										<tbody>
											<tr>
												...
												<td><button class='btn btn-xs btn-success'>Process</button>
													&nbsp;
													<button class='btn btn-xs  label-warning'>Cancel</button></td>
											</tr>
										</tbody>
									</table>
								</div>

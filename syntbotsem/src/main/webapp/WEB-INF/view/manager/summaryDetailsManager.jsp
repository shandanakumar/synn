...
<title>SyntBots Manager Summary Service Extensions</title>
	...
	<aside id="left-panel">
		...
		<nav>
			<ul>
				...
				<li class="active"><a href="serviceExtensionManager"
				...
				<div class="row">
					...
					<div>
						<p style="padding-left: 20px;">
							Your order has been submitted successfully.Please use the
							<code>Environment Request Number</code>
							to track your order.
						</p>
						<br>
					</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="tags"> Durations</label> <input type="text"
										class="form-control" id="tags" placeholder="From Date" />
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label for="tags">&nbsp;</label> <input type="text"
										class="form-control" id="tags" placeholder="To Date" />
								</div>
							</div>
						</div>
							...
							<div class="col-md-12">
								<div class="form-group">
									<label for="tags"> Http Container Port</label> <input
										type="text" class="form-control" placeholder="8080" required />
								</div>
					...
					<div class="modal-footer">
						...
						<a class="btn btn-success pull-right" href="summary.html">
							Save And Submit </a>
					</div>
				</div>
				<!-- /.modal-content -->

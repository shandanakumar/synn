...
<title>SyntBots Manager Custom Service</title>
			...
			<ul>
				...
				<li class="active"><a href="#"><i
					...
					<ul>
						...
						<li><a href="bespokeManager">Bespoke Service </a></li>
						<li class="active"><a href="#">Custom Service</a></li>
					</ul></li>
							...
							<div class="widget-body no-padding">
								<form class="smart-form">
									<fieldset>
										...
										<section class="col col-4">
											<label class="label"><b>Location</b></label> <label
										...
										<section class="col col-4">
											<label class="label"><b>Choose your Virtual
													DataCenter</b></label> <label class="select state-disabled"> <select
												name="prov_name" class="input-sm" id="prov_name"
												disabled="disabled">
													<option value="0" disabled="">Select</option>
							...
							<div class="widget-body no-padding">
								...
								<form class="smart-form">
									<fieldset>
										...
										<section class="col col-4">
											<label class="label">OS</label> <label class="select">
										...
										<section class="col col-4">
											<label class="label">OS Version</label> <label class="select">
										...
										<section class="col col-4">
											<label class="label">Components</label> <label class="select">
										...
										<section class="col col-4">
											<label class="label">Memory</label> <label class="select">
												<select name="country">
										...
										<section class="col col-4">
											<label class="label">VCPU</label> <label class="select">
												<select name="country">
													<option value="0" selected="" disabled="">select</option>
										...
										<section class="col col-4">
											<label class="label">Disk Size</label> <label class="select">
												<select name="country">
													<option value="0" selected="" disabled="">select</option>

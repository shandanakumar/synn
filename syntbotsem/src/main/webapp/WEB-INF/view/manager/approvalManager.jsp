...
<title>SyntBots Manager Order Approval</title>
	...
	<aside id="left-panel">
		...
		<nav>
			<ul>
				...
				<li><a href="#"><i class="fa fa-lg fa-fw fa-windows"></i>
						<span class="menu-item-parent">Provision VM</span></a>
					<ul>
				...
				<li class="active"><a href="#" title="Approval"><i
			...
			<section id="widget-grid" class="">
				...
				<div class="row">
					<div class="jarviswidget jarviswidget-color-blueLight"
						id="wid-id-2" data-widget-editbutton="false">
						<header>
									...
									<table class="table table-bordered table-striped">
										...
										<tbody>
											<tr>
												...
												<td>
													<section>
														<label class="label">Textarea</label> <label
												...
												<td><select name="Period">
														...
														<option value="1">Request for Information</option>
												</select> &nbsp;
													<button class='btn btn-xs btn-success'>Process</button></td>
											</tr>
										</tbody>
									</table>

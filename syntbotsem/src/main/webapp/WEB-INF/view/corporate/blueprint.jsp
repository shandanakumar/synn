...
<body class="menu-on-top">
	...
	<aside id="left-panel">
		...
		<nav>
			<ul>
				...
				<li  class="active"><a href="blueprint"><i
	...
	<div id="main" role="main">
		...
		<div id="content">
			...
			<form action="saveAzureBespokeTemplate" id="smart-form-register" method="POST">

				<input type="hidden" name="imageName" id="imageName" value="" /> <input
					type="hidden" name="securityName" id="securityName" value="" />
				...
				<section id="widget-grid" class="">
					...
					<div class="row">
						...
						<div class="modal fade" id="noProjQuota" tabindex="-1"
							role="dialog">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" onclick="resetFlavor();"
											data-dismiss="modal" aria-hidden="true">&times;</button>
										<h4 class="modal-title">Not Sufficient Project Quota!</h4>
									</div>
									<div class="modal-body no-padding">
										...
										<p>
											...
											a smaller Flavor.<br>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OR<br>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ask your Proj Admin to
											raise a Ticket for increasing your Projects Quota On this
											VDC.
									...
									<div class="modal-footer">
										...
										<button type="button" class="btn btn-default"
											onclick="resetFlavor();" data-dismiss="modal">
											Cancel</button>
										...
										<fieldset>
											<div class="row">
												...
												<section class="col col-6">
													<label class="label"><b>User</b></label> <label
														class="input state-disabled"> <i
														class="icon-append fa fa-user"></i> <input type="text"
														class="input-sm" value="${userValue1}" disabled="disabled">
													</label>
												</section>

												<section class="col col-6">
													<label class="label"><b>Project/Process</b></label> <label
														class="input state-disabled"> <input type="text"
														name="named" id="named" class="input-sm"
														value="${projName}" disabled="disabled">
													</label>
												</section>
											...
											<label class="input state-disabled">
												...
												<section class="col col-6">
													<label class="label">Location</label> <label
														class="select state-disabled"> <select
														name="prov_name" class="input-sm" id="prov_name"
														disabled="disabled">
												...
												<section class="col col-6">
													<label class="label">Choose your Virtual Data
														Center</label> <label class="select "> <select
														name="prov_name" class="input-sm" id="prov_name"
														onchange="javascript:showVdcFormParams(this)">
        ...
        <TR>
            ...
            <TD>
                <SELECT name="country" onchange="addRow('tb2')" >
    ...
    <table id="tb2">
    <tr>
    <TD><INPUT type="text" name="txt" value ="abc"/></TD>
    <TD><INPUT type="text" name="txt" value ="def"/></TD>
    </tr>
						...
						<div id="openstackParams" style="display: none">
											...
											<fieldset>
												<div class="row">
													...
													<section class="col col-5">
														<label class="label">Flavor</label> <label class="select">
															<select name="flavor" id="flavor">
																<option selected="selected" disabled="disabled"
																	value="0">Select flavor</option>
												...
												<option value="m1.xlarge">m1.xlarge</option> -->
													...
													<section class="col col-5">
														<label class="label">KeyPair</label> <label class="select">
													...
													<section class="col col-10">
														<label class="label">Security Group</label> <label
															class="select"> <select name="security"
															id="security">
																<option value="0" selected="" disabled="">select
												...
												<option value="test">test</option>	 -->
													...
													<section class="col col-5">
														<label class="label">Image</label> <label class="select">
												...
												<option value="Windows Server 2012">Windows Server 2012</option>		 -->
													...
													<section class="col col-5">
														<label class="label">Network</label> <label class="select">
							...
							<article class="col-sm-12 col-md-12 col-lg-3">
								...
								<div class="jarviswidget jarviswidget-color-blueLight"
									...
									<header>
										...
										<span class="pull-right" id="loading1"> <img
							...
							<article class="col-sm-12 col-md-12 col-lg-4">
								...
								<!-- Widget ID (each widget will need unique ID)-->
								<div class="jarviswidget jarviswidget-color-blueLight"
									id="wid-id-4" data-widget-colorbutton="false"
									data-widget-editbutton="false" data-widget-togglebutton="false"
									data-widget-deletebutton="false"
									data-widget-fullscreenbutton="false"
									data-widget-custombutton="true" data-widget-sortable="false">
									<header>
										...
										<h2>
											Security Group Details : <span id="groupheader"> </span>
										</h2>

										<span class="pull-right" id="loading2"><img
											src="img/ajaxLoader.gif"> </span>
									...
									<div>
										...
										<div class="widget-body no-padding smart-form">
											...
											<fieldset>
												<div class="row">
													<section class="col col-4">
														<label class="label">Instance Name </label> <label
															class="input"> <input type="text" name="vm_name"
															id="vm_name">
														</label>
													</section>
													<section class="col col-4">
														<label class="label">Start Date </label> <label
															class="input"> <i
													...
													<section class="col col-4">
														<label class="label">End Date </label> <label
															class="input"> <i
															class="icon-append fa fa-calendar"></i> <input
												...
												<div class="row">
													<section class="col col-4">
														<label class="label">Service Name</label> <label
															class="input"> <i class="icon-append fa fa-tag"></i>
															<input type="text" name="service_req_name"
															id="service_req_name">
														</label>
													</section>

													<section class="col col-4">
														<label class="label">Service Description</label> <label
															class="textarea"> <i
															class="icon-append fa fa-comment"></i> <textarea rows="2"
																name="service_desc" id="service_desc"></textarea>
														</label>
													</section>
												</div>
						...
						<div id="azureParams" style="display: none">
										...
										<div class="widget-body no-padding smart-form">
											...
											<fieldset>
												...
												<label class="input">
													...
													<section class="col col-4">
														<label class="label">Cloud Service</label> <label
															class="select"> <select name="azureCloudService"
															id="azureCloudService">
																<option selected="selected" disabled="disabled"
																	value="0">Select Cloud Service</option>
													...
													<section class="col col-4">
														<label class="label">Region</label> <label class="select">
													...
													<section class="col col-4">
														<label class="label">Storage Account</label> <label
															class="select"> <select
															name="azureStorageAccount" id="azureStorageAccount">
																<option selected="selected" disabled="disabled"
																	value="0">Select Storage Account</option>
														</select> <i></i>
														</label>
													</section>
													<section class="col col-4" id="enable">
														<label>Components</label> <select multiple
															style="width: 100%" class="select2">
															<optgroup label="Server Components">
																<option value="TomacatServer">Tomcat 8.0</option>
																<option value="WebLogic">WebLogic 12c</option>
																<option value="WebSphere">WebSphere 8.5.5</option>
															</optgroup>
															<optgroup label="DB Components">
																<option value="Mysql">Mysql 5.6</option>
																<option value="SQL">SQL Server 12.0</option>
															</optgroup>
							...
							<article class="col-sm-12 col-md-12 col-lg-12">
								...
								<!-- Widget ID (each widget will need unique ID)-->
								<div class="jarviswidget jarviswidget-color-blueLight"
									id="wid-id-6" data-widget-colorbutton="false"
									data-widget-editbutton="false" data-widget-togglebutton="false"
									data-widget-deletebutton="false"
									data-widget-fullscreenbutton="false"
									data-widget-custombutton="true" data-widget-sortable="false">
									...
									<div>
										...
										<div class="widget-body no-padding smart-form">
											...
											<section class="col col-4" >
												...
												<div style="padding-left: 180px"><INPUT type="button" value="Delete Row" onclick="deleteRow('tb2')" class="btn btn-primary"/></div>
												...
												<div class="container" ng-app>
													<div style="padding: 50px;"
														...
														<div class="row">
															...
															<div class="col-lg-5">
																<select class="input-sm" ng-model="state"
																	ng-options="s.value for s in status"></select>
															</div>
														</div>
														<br />
														<div class="row"
															ng-hide="state.value!='name'&&state.value!='all'">
														...
														<br />
														<div class="row"
															ng-hide="state.value!='address'&&state.value!='all'">
										 ...
										 <!-- <section class="col col-4">
											...
											<table id="tb2">
													<tr>
														<TD><label class="label">Protocol</label> </TD>
														<TD style="padding:0 15px 0"><INPUT type="text" name="txt"  /></TD>
														<TD style="padding:0 15px 0"><label class="label">Public PORT</label> </TD>
														<TD  style="padding:0 15px 0"><INPUT type="text" name="txt"  /></TD>
													</tr>
												</table>
												</section> -->
												...
												<table id="tb2">
													<tr>
														<TD style="padding-right: 10px"><INPUT type="text"
															name="txt" value="Selected End Points" /></TD>
														<TD><INPUT type="text" name="txt" value="end Points" /></TD>
												...
												<div class="row">
													...
													<section class="col col-4" id="enable1">
														<label class="label">Visible To</label> <select multiple
															style="width: 100%" class="select2">
															<optgroup label="STG Development">
							...
							<fieldset>
								<div class="row">
						             <section class="col col-4">
												...
												<label class="input">
													<input type="text" name="bluePrintName" id="bluePrintName" >
												</label>
									</section>
											 <section class="col col-4">
					                        <label class="label">BluePrint Description</label>
												<label class="input">
													<input type="text" name="bluePrintDesc" id="bluePrintDesc" >
												</label>
											</section>
											...
											<div class="row">
												<section class="col col-4">
													<label class="label">Public</label> <input type="checkbox"
														name="publicCheckbox" id="publicCheckbox" onclick="visiblity()">

												</section>
												<section class="col col-4" id="enable" hidden>
													<label>Enable To</label> <select multiple 
														style="width: 100%" class="select2" >
	...
	<script type="text/javascript">
		...
		function visiblity(){
			var checkboxvalue=$("#publicCheckbox").is(":checked");
			//alert("checkboxvalue"+checkboxvalue);
			if (checkboxvalue == true) {
				$('#enable1').prop('hidden', true); 
				
				//$('#enable1').modal('show');
				
			} else {
				//document.getElementById('enable1').disable;
				$('#enable1').removeAttr('hidden');
				//$('#enable1').modal('hide');
			}
		}
		</script>
  ...
  function launchAzureInstance(){
	 alert("inside launchAzureInstance");
	  ...
	  varAzureLaunchJsonObj['azureRegion'] = document.getElementById("azureRegion").value;
	  ...
	  alert(strJSON);
	<%--  fnCommonDoAjaxForSave("<%=request.getContextPath()%>/launchAzureVM", strJSON,  "fnFnAfterlaunchAzureVM", "fnFnErrAfterlaunchAzureVM");  --%>

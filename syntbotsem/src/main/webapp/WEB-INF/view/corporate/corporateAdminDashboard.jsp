...
<body class=" ">
	...
	<aside id="left-panel">
		...
		<nav>
			<ul>
				<li class="active"><a href="departmentHome" title="Dashboard"><i
							...
							<div class="col-md-4 padding-left-0">
								<h3 class="margin-top-0">
									<a href="javascript:void(0);">
										...
										class="btn btn-primary pull-right" href="departmentList">
										List / Add Department </a> <br>
								</h3>

...
<title>SyntBots templateListPage - Department Home</title>
			...
			<section id="widget-grid" class="">
				...
				<div class="row">
					<div class="pull-right" style="padding-right: 2%;">
						<a data-toggle="modal" href="#myModal" onclick="addTemplate1();"
							class="btn btn-success txt-color-white pull-right  "> <i
							class="fa fa-circle-arrow-up fa-lg"></i> Add Template
						</a> <br> <br>
					</div>
										...
										<thead>
											<tr>
												...
												<th data-hide="phone,tablet"><i
													...
													VCPU</th>
												<th data-hide="phone,tablet"><i
													class="txt-color-blue hidden-md hidden-sm hidden-xs"></i>RAM</th>

...
<title>SyntBots Add Template Page</title>
...
<body class="">
	...
	<aside id="left-panel">
		...
		<nav>
			<ul>
				...
				<li class="active"><a href="templateList" title="templateList"><i
						class="fa  fa-group"></i> <span class="menu-item-parent">Template
							List</span></a></li>

				<li><a href="#"><i class="fa fa-lg fa-fw fa-cogs"></i> <span
						class="menu-item-parent"> Quota</span></a></li>
		</nav>
			...
			<form action="customLaunch" id="smart-form-register" method="POST">
				...
				<section id="widget-grid" class="">
					...
					<div class="row">
											...
											<div class="row">
												...
												<section class="col col-4">
													<label class="label"><b>User</b></label> <label
														...
														class="input-sm" value="user" disabled="disabled">
													</label>
												</section>
												...
												<section class="col col-4">
													<label class="label"><b>Project/Process</b></label> <label
														...
														value="MSO-STG/92095" disabled="disabled">
													</label>
												</section>

												<section class="col col-4">
													<label class="label"><b>Notify By</b></label> <label
														class="input state-disabled"> <input type="text"
														name="named" id="named" class="input-sm" value="ISAP"
														disabled="disabled">
													</label>
												</section>
												...
												<section class="col col-4">
													...
													<label class="label"><b>Email Id</b></label> <label
														class="input state-disabled"> <i
														class="icon-append fa fa-envelope"></i> <input type="text"
														name="named" id="named" class="input-sm"
														value="user@syntelinc.com" disabled="disabled">
													</label>
												</section>
												...
												<section class="col col-4">
													<label class="label">Choose your Virtual Data
														...
														name="mc-formPaymentDate" id="vdcid">
						...
						<section id="widget-grid" class="multiselectdullbox"
	...
	<script
		src="js/plugin/bootstrap-timepicker/bootstrap-timepicker.min.js"></script>
	...
	<script
		src="js/plugin/bootstrap-duallistbox/jquery.bootstrap-duallistbox.min.js"></script>

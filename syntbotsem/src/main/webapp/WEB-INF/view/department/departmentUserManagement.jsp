							...
							<br><br>
								...
								<div class="modal-content">
										...
										<div class="modal-body no-padding">
											<form action="addCPoolUser" id="pool-form" class="smart-form" method="POST">
											<fieldset>
											<section>
											
												<label class="label"> Select Pool Users </label>
												<label class="select select-multiple"> 
												<select class ="custom-scroll" multiple="" name="user_name" id=cpoolUser></select>
													</label>
				...
				<!-- NEW WIDGET START -->
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<!-- widget content -->
								...
								<!-- onclick="getRow(this);"		onclick="deleteDepartment(this)" -->		
				            ...
				            <div class="modal-content">
                                <div class="modal-header">
                                   <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                    ...
                                    <h4 class="modal-title">
                                       Attention: There are no user in this Corporate pool!
                                    </h4>
                                </div>
                                <div class="modal-body no-padding">
                                 		&nbsp;&nbsp;&nbsp;<p>
						               	...
						               	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please Add Users in Corporate Group
						                <br>
						                <br>
						            </p>
						        </div>
...
function getUserNameDetails(data){
	  $('#cpoolUser').html('');     
	 $.getJSON("./getCPoolUsers",function(response){

...
<html lang="en-us">
	<head>
		...
		<title> SyntBots User Order Summary Page </title>
      ...
      <body class="desktop-detected menu-on-top pace-done smart-style-4">
		...
		<aside id="left-panel">
			...
			<nav>
				<ul>
					...
					<li class="active">
						<a href="#" title="Order Status"><i class="fa fa-lg fa-fw fa-list-alt "></i> <span class="menu-item-parent">Order Status</span></a>
					</li>
		...
		<div id="main" role="main">
				...
				<div id="ribbon">
					...
					<!-- breadcrumb -->
					<ol class="breadcrumb">
						<li>Home</li><li> Service</li><li>Insta</li><li>Ordersummary</li>
					</ol>
					<!-- end breadcrumb -->
											...
											<table class="table table-bordered">
												...
												<tbody>
													<tr>
														...
														<th>Created Date:  12/20/2014</th>
														
													</tr>
													<tr>
														<th>Bill To  PID  : Project 92095</th>
														<th>Submitted Date  :  12/21/2014</th>

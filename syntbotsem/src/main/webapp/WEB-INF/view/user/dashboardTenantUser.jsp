				...
				<ul>
					...
					<li>
						...
						<ul>
							...
							<li>
								<a href="customUser">Custom Service  </a>
							</li>
						</ul>
					</li>
							...
							<div class="row">
								...
								<div class="col-md-4 padding-left-0">
									<h3 class="margin-top-0">
									   ...
									   <a class="btn btn-primary pull-right" href="stackUser"> Create Request </a>
									   <br>
									</h3>
								...
								<div class="col-md-4 padding-left-0">
									<h3 class="margin-top-0">
									   ...
									   <a class="btn btn-primary pull-right" href="bespokeUser"> Create Request </a>
									    <br>
									</h3>
						    ...
						    <div class="row">
								...
								<div class="col-md-4 padding-left-0">
									<h3 class="margin-top-0">
										...
										<a class="btn btn-primary pull-right" href="customUser"> Create Request </a>
									    <br>
									</h3>
									<p>	Order your VM and select your hardware configuration <br><br>
                                        On-demand Cloud servers <br><br>
                                        Only 5 VM’s per project<br><br>

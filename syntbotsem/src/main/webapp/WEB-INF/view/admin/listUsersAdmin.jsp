...
<html lang="en-us">
	<head>
	<meta charset="utf-8">
		<title>SyntBots ListUsers</title>
 ...
 <body class="desktop-detected menu-on-top pace-done smart-style-4">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Home</li><li>Policies</li><li>List Users</li>
				</ol>
				<!-- end breadcrumb -->
										...
										<div class="input-group">
                                           <span class="input-group-addon">
                                            ...
                                            <select class="form-control">
													...
													<option value="Team Lead">Amex</option>
													<option value="System Analyst">Fedex</option>
													<option value="Project Manager">CISCO</option>
													<option value="Project Manager">Belk</option>
													<option value="Project Manager">Home depot</option>
													<option value="Project Manager">All State</option>
										       </select>									                    
										      </div>
											</div>
									</div>
										...
										<div class="table-responsive">									
											<table class="table table-bordered table-striped">
												...
												<tr>
													...
													<th data-hide="phone,tablet"><i class="txt-color-blue hidden-md hidden-sm hidden-xs"></i> Email</th>
											...
											<tbody>
												<tr>
													<td>Vijay</td>
													<td>vijay@syntel.com</td>
													<td>Tentant-Admin</td>
													
												</tr>
												<tr>
													<td>Shandan</td>
													<td>Shandan@syntel.com</td>
													<td>Tentant-Admin</td>
													
												</tr>
												<tr>
													<td>Boopathy</td>
													<td>Boopathy@syntel.com</td>
													<td>ISAP Business-Admin</td>
													
												</tr>
												<tr>
													<td>Kalyan</td>
													<td>Kalyan@syntel.com</td>
													<td>Tentant-Admin</td>
													
												</tr>
												<tr>
													<td>Ravi</td>
													<td>Ravi@syntel.com</td>
													<td>ISAP Business-Admin</td>
													
												</tr><tr>
													<td>Rajesh</td>
													<td>Rajesh@syntel.com</td>
													<td>Tentant-Admin</td>

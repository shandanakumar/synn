...
<html lang="en-us">
    <head>
        ...
        <title>SyntBots - User Management</title>
									...
									<div class="widget-body no-padding">
                                       ...
                                       <span class="label label-danger">InActive</span>
                                        ...
                                        <td  style="padding-left: 3%;">
												...
												<a title="edit" href="#" data-toggle="modal" id="${users.usr_id}" name="${users.usr_name}" onclick="getRow(this);" ><i class="fa fa-pencil"></i></a>

...
public class VdcCgQuotaMap implements Serializable {
	...
	private CorporateGroups corpbean;

	private VdcMaster vdcMasterBean;
	
	public VdcMaster getVdcMasterBean() {
		return vdcMasterBean;
	}

	public void setVdcMasterBean(VdcMaster vdcMasterBean) {
		this.vdcMasterBean = vdcMasterBean;
	}

	public CorporateGroups getCorpbean() {
		return corpbean;
	}

	public void setCorpbean(CorporateGroups corpbean) {

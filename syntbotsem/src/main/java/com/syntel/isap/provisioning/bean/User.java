...
public class User implements Serializable {
	...
	private List<CustomVM> custom_VMList;
	
	public List<CustomVM> getCustom_VMList() {
		return custom_VMList;
	}

	public void setCustom_VMList(List<CustomVM> custom_VMList) {
		this.custom_VMList = custom_VMList;
	}
	...
	// below field added for NAGAMANI join query logic: need to discuss abt bean
	// implementation

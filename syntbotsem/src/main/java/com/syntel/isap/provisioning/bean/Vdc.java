...
public class Vdc implements Serializable {
	...
	private VdcList azureVdcList;

	public VdcList getAzureVdcList() {
		return azureVdcList;
	}

	public void setAzureVdcList(VdcList azureVdcList) {
		this.azureVdcList = azureVdcList;
	}
	...
	public String toString() {
		return "Vdc [status=" + status + ", result=" + result + ", user="
				+ user + ", password=" + password + ", vdc_id=" + vdc_id
				+ ", vdc_name=" + vdc_name + ", description=" + description
				+ ", vdc_location=" + vdc_location + ", version=" + version
				+ ", subnet_address=" + subnet_address
				+ ", controller_endpoint=" + controller_endpoint
				+ ", keystone_endpoint=" + keystone_endpoint + ", tenant="
				+ tenant + ", region=" + region + ", azureVdcDetails="
				+ ", scm_name=" + scm_name + ", scm_id="
				+ scm_id + ", mon_id=" + mon_id + ", mon_name=" + mon_name
				+ ", created_at=" + created_at + ", vdc_status=" + vdc_status
				+ ", vdc_provider=" + vdc_provider + ", VdcExt=" + VdcExt
				+ ", vdclist=" + vdclist + ", azureVdcList=" + azureVdcList
				+ ", vdc=" + vdc + "]";
	}

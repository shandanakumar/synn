...
//insertRoleIdforUserIdInRolemap(roleId,usrId);
	...
	public void getEndUserFromUserTable(int usrID) {
		// TODO Auto-generated method stub
		isapAdminUserMapper.getEndUserFromUserTable(usrID);
	}

	public void getEndUserFromUserTable2(int usrID) {
		// TODO Auto-generated method stub
		isapAdminUserMapper.getEndUserFromUserTable2(usrID);
	}
...
*/
	...
	public void updateOldDeptAdminrole(int oldAdminId) {
		// TODO Auto-generated method stub
		isapAdminUserMapper.updateOldDeptAdminrole(oldAdminId);
	}

	public void updateOldProjAdminrole(int oldAdminId) {
		// TODO Auto-generated method stub
		isapAdminUserMapper.updateOldProjAdminrole(oldAdminId);
	}
	...
	public String getRoleName(int usr_id) {
		// TODO Auto-generated method stub
		return isapAdminUserMapper.getRoleName(usr_id);
	}

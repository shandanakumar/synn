...
public class DashboardController {
	...
	private static final Logger LOGGER = Logger.getLogger(DashboardController.class.getName());
	  ...
	  @RequestMapping(value ="/dashboardProject", method = RequestMethod.GET)
		public ModelAndView projectEndUser() {
		  ModelAndView model = new ModelAndView();
			
			String view = "manager/dashboardProject";
			  model.setViewName(view);
			return  model;
		}
	  ...
	  @RequestMapping(value = "/departmentHome", method = RequestMethod.GET)
		public ModelAndView departmentHome() {
			ModelAndView model = new ModelAndView();
			String view = "corporate/corporateAdminDashboard";
			model.setViewName(view);
			return model;
		}
